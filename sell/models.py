...
class Seller(models.Model):
    ...
    equipment_id6 = models.CharField(max_length=50, blank=True)
    equipment_id7 = models.CharField(max_length=50, blank=True)
    equipment_id8 = models.CharField(max_length=50, blank=True)
    equipment_id9 = models.CharField(max_length=50, blank=True)
    equipment_id10 = models.CharField(max_length=50, blank=True)
